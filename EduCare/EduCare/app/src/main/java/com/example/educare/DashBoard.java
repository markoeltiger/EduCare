...
import com.example.educare.student.chat_activity;
                        ...
                        if (users.getPassword().equals(password)){
                           if (parentDbName.equals("Users")){ Toast.makeText(DashBoard.this,"Welcome "+users.getName().toString()+".",Toast.LENGTH_SHORT).show();
                               ...
                               if(Doc.isChecked()){User_Type="Doctor";
                                   Intent profintent =new Intent(DashBoard.this, professors.class);
                         ...
                         /*       Intent HomeIntent =new Intent(DashBoard.this,chat_activity.class);
